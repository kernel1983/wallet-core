...
#include "Filecoin/BinaryCoding.h"
#include "HexCoding.h"
#include "Base64.h"
...
// TEST(FilecoinSigner, EncodeNumbers) {
//     auto tests = {
...
// TEST(FilecoinSigner, EncodeStrings) {
//     auto tests = {
...
TEST(FilecoinSigner, EncodeBytes) {
...
TEST(FilecoinSigner, Sign) {
    auto key = PrivateKey(parse_hex("24dee5d2ceda995013f3227628a75f57185c9b9a52b1415a7b87aecf340b923a"));
    auto publicKey = key.getPublicKey(TWPublicKeyTypeSECP256k1);
    auto from = Address(publicKey);
    auto to = Address("f17uoq6tp427uzv7fztkbsnn64iwotfrristwpryy");
    // Data note;
